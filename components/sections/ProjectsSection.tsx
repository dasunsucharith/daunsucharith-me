...
const projects = [
  ...
  },
  {
    ...
    description: 'A comprehensive dashboard for SaaS businesses with analytics and billing integration.',
    url: 'https://example.com'
  },
  {
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {projects.map((project, idx) => (
            ...
            >
              ...
              <p className="text-brand-muted text-sm leading-relaxed">{project.description}</p>
            </motion.a>
          ))}
        </div>
      </div>
