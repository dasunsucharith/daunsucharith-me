            ...
            {featuredProjects.map((project, index) => (
              ...
              >
                <div className={index % 2 === 1 ? 'lg:order-2' : ''}>
                  <div className="bg-gray-100 rounded-2xl aspect-video flex items-center justify-center text-gray-500 mb-4">
                ...
                <div className={index % 2 === 1 ? 'lg:order-1' : ''}>
                  ...
                  <div className="flex gap-4">
                    <a
                      ...
                      className="flex items-center gap-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-full font-semibold hover:shadow-lg transition-shadow"
                    >
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-2 border-2 border-gray-300 text-gray-700 px-6 py-3 rounded-full font-semibold hover:border-gray-400 transition-colors"
                    >
            ...
            >
              {filteredProjects.map((project, index) => (
                <motion.div
                  ...
                  whileHover={{ y: -5 }}
                >
                  <div className="bg-gray-100 aspect-video flex items-center justify-center text-gray-500 relative overflow-hidden">
                    <div className="text-center">
